...
221228 bringing various environmental factors as far forward as possible within the github context - docs publishing via github actions to github pages, package publishing to pypi via github actions.
